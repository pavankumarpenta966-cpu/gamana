...
const ContactPage = () => {
  ...
  const handleSubmit = async () => {
    try {
      await fetch(
        "https://script.google.com/macros/s/AKfycbwuxRx12oRoRLIDjjs9ls2fo3nDNjvmlBx4beC_mLemOXXiKcup1It5cVRjBS5tt_d1_Q/exec",
        {
          method: "POST",
          mode: "no-cors",
              ...
              <motion.div {...fadeInLeft} className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 mb-4 text-sm leading-relaxed">
                    We welcome partnerships, collaborations, volunteer
                    engagements and inquiries from individuals and organizations
                    who share our vision of building child-friendly,
                    gender-equitable communities. Our team is available to
                    discuss program details, project collaborations and field
                ...
                <div>
                  ...
                  <div className="space-y-5">
                    ...
                    >
                      ...
                      <div>
                        <a
                          href="mailto:gamanatheway@gmail.com"
                          className="text-gray-700 hover:text-green-600 transition-colors font-medium"
                        >
